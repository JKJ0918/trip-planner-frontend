  ...
  return (
    <footer className="bg-grat-200 text-gray-300 py-12 px-6 mt-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
        ...
        {/* 소개 */}
        <div>
          <h4 className="text-black text-lg font-semibold mb-3">TRIPPLANNER</h4>
          <p className="text-gray-500">당신의 여행을 쉽고 즐겁게 만들어주는 플랫폼.</p>
          <p className="text-gray-500">© 2025 Travel Planner. All rights reserved.</p>
        </div>

        {/* 링크 */}
        <div>
          <h4 className="text-black font-semibold mb-3">바로가기</h4>
        ...
        {/* 연락처 */}
        <div>
          <h4 className="text-black font-semibold mb-3">문의</h4>
          <p className="text-gray-500">이메일: whrjswo123@naver.com</p>
          <p className="text-gray-500">전화: 010-1234-5678</p>
